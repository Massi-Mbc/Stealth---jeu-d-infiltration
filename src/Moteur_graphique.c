...
/*Gere l'affichage du temps sur la fenêtre graphique.*/
...
/*Gere l'affichage du mana du joueur sur la fenêtre graphique.*/
...
/*Dessine le plateau de jeu à partir du plateau passer par pointeur.*/
