...
/*
Fonction auxilière pour afficher la tableau de score.
*/
static void affiche_score_bis(Tab_score *all_score){
    int i;
    char tmp[20];
...
/*
Fonction qui fabrique une case du menu (exclusivement).
*/
...
/*
Fonction qui fabrique une case retour.
*/
...
/*
Permet l'affichage du menu sur la fenêtre graphique.
*/
...
/*
Permet l'affichage du menu option sur la fenêtre graphique (déclencher par un clic).
*/
...
/*
Fonction qui affiche le menu entier sur la fenêtre graphique.
*/
void affiche_menu(){
    char lance_jeu[15];
    char option[15];
...
/*
Affiche l'écran de défaite, si le joueur se fait voir par un gardien.
*/
static void ecran_perdant(){
    MLV_Image *pic;
    pic = MLV_load_image("src/loose.jpg");
    MLV_clear_window(MLV_COLOR_BLACK);
...
/*
Permets l'affichage d'un écran en fin de jeu selon la victoire ou la defaite du joueur.
*/
