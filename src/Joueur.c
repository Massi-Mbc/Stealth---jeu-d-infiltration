...
/*
S'occupe de changer la vitesse selon le mode actuel du joueur.
*/
static void change_vitesse_joueur(Mode_joueur *mode, double *vitesse){
...
/*
Augmente la vitesse d'un joueur au fur et à mesure qu'il avance.
*/
...
/*
Configure le mode NORMAL pour le gardien.
*/
...
/*
Initialise les champs du joueur pour le début d'une partie.
*/
